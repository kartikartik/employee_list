...
class EditEmployeeScreen extends StatefulWidget {
  final EmployeeListModel empData;
  EditEmployeeScreen({Key? key, required this.empData}) : super(key: key);
...
class _EditEmployeeScreenState extends State<EditEmployeeScreen> {
  ...
  void initState() {
    ...
    super.initState();
    _empNameController.text = widget.empData.empName!;
    dropdownValue = widget.empData.empRole!;

    _selectedDate.value = widget.empData.empFromDate!;
    _selectedToDate.value = widget.empData.empToDate!.isEmpty
        ? "No Date"
        : widget.empData.empToDate!;
  }
          ...
          child: Column(
            children: <Widget>[
              ...
              MaterialButton(
                  ...
                  onPressed: () {
                    empListBloc.updateEmpList(EmployeeListModel(
                      id: widget.empData.id,
                      empName: _empNameController.text,
                      empRole: dropdownValue,
                      empFromDate: _selectedDate.value,
                      empToDate: _selectedToDate.hasValue
                          ? _selectedToDate.value == "No Date"
                              ? ""
                              : _selectedToDate.valueOrNull
                          : "",
                      done: false,
                    ));
